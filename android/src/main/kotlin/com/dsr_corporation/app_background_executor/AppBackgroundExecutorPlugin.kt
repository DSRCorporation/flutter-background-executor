...
package com.dsr_corporation.app_background_executor
...
import com.dsr_corporation.app_background_executor.constants.DefaultValues
import com.dsr_corporation.app_background_executor.constants.Definitions
import com.dsr_corporation.app_background_executor.dtos.*
import com.dsr_corporation.app_background_executor.helpers.PreferencesHelper
import com.dsr_corporation.app_background_executor.runners.FlutterEngineRunner
import com.dsr_corporation.app_background_executor.utils.MessageUtils
import com.dsr_corporation.app_background_executor.utils.RunningTaskUtils
import com.dsr_corporation.app_background_executor.workers.AppBackgroundExecutorWorker
...
/** AppBackgroundExecutorPlugin */
class AppBackgroundExecutorPlugin : FlutterPlugin, MethodCallHandler {
    ...
    private fun getCreatedTaskIdentifier(context: Context): String {
        ...
        val tasks = workManager.getWorkInfosByTag(AppBackgroundExecutorWorker::class.java.name).get()
    ...
    private fun createTask(request: CreateRefreshTaskRequest, context: Context): String {
        val details = request.details
        val workManager = WorkManager.getInstance(context)
        workManager.cancelAllWorkByTag(AppBackgroundExecutorWorker::class.java.name)
        ...
        val requestBuilder = PeriodicWorkRequestBuilder<AppBackgroundExecutorWorker>(
