...
class CreateRefreshTaskResponse {
  ...
  factory CreateRefreshTaskResponse.fromMap(Map<String, dynamic> map) {
    return CreateRefreshTaskResponse(
      isSuccess: map[Definitions.isSuccessParam],
      taskIdentifier: map[Definitions.taskIdentifierParam],
    );
  }
}
